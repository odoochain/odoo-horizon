...
class Annexe5Xlsx(ReportXlsx):
    ...
    def generate_xlsx_report(self, workbook, data, saturn):
        ...
        sheet.write(i, 34, u'Activité')
        sheet.write(i, 35, u'Inscr.')
        sheet.write(i, 36, u'Code saturn')
        sheet.write(i, 37, u'U/HE/ESA/PS')
        sheet.write(i, 38, u'Résultat')
        sheet.write(i, 39, u'PAE_num')
        sheet.write(i, 40, u'PAE_dén.')
        sheet.write(i, 41, u'Activité')
        sheet.write(i, 42, u'Inscr.')
        sheet.write(i, 43, u'Code saturn')
        sheet.write(i, 44, u'U/HE/ESA/PS')
        sheet.write(i, 45, u'Résultat')
        sheet.write(i, 46, u'PAE_num')
        sheet.write(i, 47, u'PAE_dén.')
        sheet.write(i, 48, u'Activité')
        sheet.write(i, 49, u'Inscr.')
        sheet.write(i, 50, u'Code saturn')
        sheet.write(i, 51, u'U/HE/ESA/PS')
        sheet.write(i, 52, u'Résultat')
        sheet.write(i, 53, u'PAE_num')
        sheet.write(i, 54, u'PAE_dén.')
        sheet.write(i, 55, u'Activité')
        sheet.write(i, 56, u'Inscr.')
        sheet.write(i, 57, u'Code saturn')
        sheet.write(i, 58, u'U/HE/ESA/PS')
        sheet.write(i, 59, u'Résultat')
        sheet.write(i, 60, u'PAE_num')
        sheet.write(i, 61, u'PAE_dén.')
        sheet.write(i, 62, u'Activité')
        sheet.write(i, 63, u'Inscr.')
        sheet.write(i, 64, u'Code saturn')
        sheet.write(i, 65, u'U/HE/ESA/PS')
        sheet.write(i, 66, u'Résultat')
        sheet.write(i, 67, u'PAE_num')
        sheet.write(i, 68, u'PAE_dén.')
        sheet.write(i, 69, u'A ENCODER SUR FICHIER SEPARE')
        sheet.write(i, 70, u'A ENCODER SUR FICHIER SEPARE')
        ...
        sheet.write(i, 76, u'A ENCODER SUR FICHIER SEPARE')
        sheet.write(i, 77, u'A ENCODER SUR FICHIER SEPARE')
        sheet.write(i, 78, u'A ENCODER SUR FICHIER SEPARE')
        sheet.write(i, 79, u'A ENCODER SUR FICHIER SEPARE')
        ...
        for bloc_id in saturn.bloc_ids:
            ...
            if bloc_id.invoice_id :
                ...
                if bloc_id.invoice_id.payment_move_line_ids :
                    sheet.write(i, 22, min(bloc_id.invoice_id.payment_move_line_ids.mapped('date')))
                if bloc_id.invoice_id.residual == 0 and bloc_id.invoice_id.payment_move_line_ids :
            ...
            if hist_bloc_id :
                ...
                sheet.write(i, 34, 'ETU')
                if self._is_dcc_bloc(hist_bloc_id) :
                    sheet.write(i, 35, 'DCC')
                elif hist_bloc_id.source_bloc_level == '1' :
                    sheet.write(i, 35, '1A1C')
                elif hist_bloc_id.source_bloc_level in ('2','3') :
                    sheet.write(i, 35, '>45')
                else:
                    sheet.write(i, 35, '1A2C')
                sheet.write(i, 36, program_id.track_id.saturn_code)
                sheet.write(i, 37, 'ESA')
                if hist_bloc_id.state in ('awarded_first_session','awarded_second_session'):
                    sheet.write(i, 38, 'R')
                else :
                    sheet.write(i, 38, 'E')
                sheet.write(i, 39, hist_bloc_id.total_acquiered_credits)
                sheet.write(i, 40, hist_bloc_id.total_credits)
            else :    
                ...
                if hist_id:
                    ...
                    sheet.write(i, 37, hist_id.type or '')
                    sheet.write(i, 38, hist_id.resultat or '')
                    sheet.write(i, 39, hist_id.pae_num or '')
                    sheet.write(i, 40, hist_id.pae_den or '')
            ...
            if hist_bloc_id :
                hist_bloc_id = hist_bloc_id[0]
                sheet.write(i, 41, 'ETU')
                if self._is_dcc_bloc(hist_bloc_id) :
                    sheet.write(i, 42, 'DCC')
                elif hist_bloc_id.source_bloc_level == '1' :
                    sheet.write(i, 42, '1A1C')
                elif hist_bloc_id.source_bloc_level in ('2','3') :
                    sheet.write(i, 42, '>45')
                else:
                    sheet.write(i, 42, '1A2C')
                sheet.write(i, 43, program_id.track_id.saturn_code)
                sheet.write(i, 44, 'ESA')
                if hist_bloc_id.state in ('awarded_first_session','awarded_second_session'):
                    sheet.write(i, 45, 'R')
                else :
                    sheet.write(i, 45, 'E')
                sheet.write(i, 46, hist_bloc_id.total_acquiered_credits)
                sheet.write(i, 47, hist_bloc_id.total_credits)
            else :    
                hist_id = self.env['school.student_annexe5_entry'].search([('year_id','=',year_id.id),('student_id','=',bloc_id.student_id.id)])
                if hist_id:
                    hist_id = hist_id[0]
                    ...
                    sheet.write(i, 44, hist_id.type or '')
                    sheet.write(i, 45, hist_id.resultat or '')
                    sheet.write(i, 46, hist_id.pae_num or '')
                    sheet.write(i, 47, hist_id.pae_den or '')
            ...
            if hist_bloc_id :
                hist_bloc_id = hist_bloc_id[0]
                sheet.write(i, 48, 'ETU')
                if self._is_dcc_bloc(hist_bloc_id) :
                    sheet.write(i, 49, 'DCC')
                elif hist_bloc_id.source_bloc_level == '1' :
                    sheet.write(i, 49, '1A1C')
                elif hist_bloc_id.source_bloc_level in ('2','3') :
                    sheet.write(i, 49, '>45')
                else:
                    sheet.write(i, 49, '1A2C')
                sheet.write(i, 50, program_id.track_id.saturn_code)
                sheet.write(i, 51, 'ESA')
                if hist_bloc_id.state in ('awarded_first_session','awarded_second_session'):
                    sheet.write(i, 52, 'R')
                else :
                    sheet.write(i, 52, 'E')
                sheet.write(i, 53, hist_bloc_id.total_acquiered_credits)
                sheet.write(i, 54, hist_bloc_id.total_credits)
            else :
                hist_id = self.env['school.student_annexe5_entry'].search([('year_id','=',year_id.id),('student_id','=',bloc_id.student_id.id)])
                if hist_id:
                    hist_id = hist_id[0]
                    ...
                    sheet.write(i, 51, hist_id.type or '')
                    sheet.write(i, 52, hist_id.resultat or '')
                    sheet.write(i, 53, hist_id.pae_num or '')
                    sheet.write(i, 54, hist_id.pae_den or '')
            ...
            if hist_bloc_id :
                hist_bloc_id = hist_bloc_id[0]
                sheet.write(i, 55, 'ETU')
                if self._is_dcc_bloc(hist_bloc_id) :
                    sheet.write(i, 56, 'DCC')
                elif hist_bloc_id.source_bloc_level == '1' :
                    sheet.write(i, 56, '1A1C')
                elif hist_bloc_id.source_bloc_level in ('2','3') :
                    sheet.write(i, 56, '>45')
                else:
                    sheet.write(i, 56, '1A2C')
                ...
                if hist_id:
                    ...
                    sheet.write(i, 58, hist_id.type or '')
                    sheet.write(i, 59, hist_id.resultat or '')
                    sheet.write(i, 60, hist_id.pae_num or '')
                    sheet.write(i, 61, hist_id.pae_den or '')
            ...
            if hist_bloc_id :
                hist_bloc_id = hist_bloc_id[0]
                sheet.write(i, 62, 'ETU')
                if self._is_dcc_bloc(hist_bloc_id) :
                    sheet.write(i, 63, 'DCC')
                elif hist_bloc_id.source_bloc_level == '1' :
                    sheet.write(i, 63, '1A1C')
                elif hist_bloc_id.source_bloc_level in ('2','3') :
                    sheet.write(i, 63, '>45')
                else:
                    sheet.write(i, 63, '1A2C')
                sheet.write(i, 64, program_id.track_id.saturn_code)
                sheet.write(i, 65, 'ESA')
                if hist_bloc_id.state in ('awarded_first_session','awarded_second_session'):
                    sheet.write(i, 66, 'R')
                else :
                    sheet.write(i, 66, 'E')
                sheet.write(i, 67, hist_bloc_id.total_acquiered_credits)
                sheet.write(i, 68, hist_bloc_id.total_credits)
            else :    
                hist_id = self.env['school.student_annexe5_entry'].search([('year_id','=',year_id.id),('student_id','=',bloc_id.student_id.id)])
                if hist_id:
                    hist_id = hist_id[0]
                    ...
                    sheet.write(i, 65, hist_id.type or '')
                    sheet.write(i, 66, hist_id.resultat or '')
                    sheet.write(i, 67, hist_id.pae_num or '')
                    sheet.write(i, 68, hist_id.pae_den or '')
            ...
            sheet.write(i, 80, bloc_id.total_credits-bloc_id.total_dispensed_credits)
            #sheet.write(i, 81, u'A ENCODER SUR FICHIER SEPARE')
            #sheet.write(i, 82, u'A ENCODER SUR FICHIER SEPARE')
