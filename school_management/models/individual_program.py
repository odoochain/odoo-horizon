...
class IndividualCourseGroup(models.Model):
    ...
    source_course_group_id = fields.Many2one('school.course_group', string="Source Course Group", ondelete="restrict", domain="[['id','in',self.bloc_id.program_id.course_group_summaries.course_id]]")
    ...
    bloc_id = fields.Many2one('school.individual_bloc', string="Bloc", ondelete='cascade')
