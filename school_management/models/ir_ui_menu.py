...
class IrUiMenu(models.Model):
    ...
    display_in_home_menu = fields.Boolean(string="Displayed in home menu", help="Menu to add in the Horizon Home menu.", default=False)
    simulated_id = fields.Many2one('ir.ui.menu', string='Simulated Menu', help="Already existing menu that this Home menu must simulate.", default=False, index=True, ondelete="restrict")
    ...
    def load_web_menus(self, debug):
        ...
        for key, web_menu in web_menus.items():
            try:
                ...
                (simulated_id, simulated_label) = simulated_menu if simulated_menu else (web_menu["id"], "")
            except ValueError:
