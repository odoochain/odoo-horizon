...
class IrActionsReport(models.Model):
    ...
    def _render_qweb_pdf(self, report_ref, res_ids=None, data=None):
        ...
        pdf_content, type = super(IrActionsReport, self)._render_qweb_pdf(report_ref=report_ref, res_ids=res_ids,
                                                                          data=data)
        ...
        if google_service and self.google_drive_enabled and len(res_ids) == 1:
            ...
            if partner_id.google_drive_folder_id:
                ...
                file = google_service.create_file(content, report_name, 'application/pdf',
