...
class IndividualProgram(models.Model):
    ...
    def _compute_ind_course_group_ids_eval(self):
        ...
        self.remaining_course_group_ids = self.source_program_id.course_group_ids - self.env['school.course_group'].browse(self.acquired_ind_course_group_ids.mapped('source_course_id'))
